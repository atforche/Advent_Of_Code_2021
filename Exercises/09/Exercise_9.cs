...
namespace Advent_Of_Code_2021.Exercises
{
    class Exercise_9
    {
        ...
        {
            // Read in the input
            string current_directory = "C:\\Users\\atfor\\OneDrive\\Desktop\\Code_Projects\\Advent_of_Code_2021\\Exercises\\9\\";
        ...
        private void add_line(ref int[,] grid, int start_x, int start_y, int end_x, int end_y) {
            ...
            // Ignore non-vertical or non-horizontal lines
            if (x_diff != 0 && y_diff != 0) {
                return;
            }

            int total_movement = Math.Abs(x_diff + y_diff);
